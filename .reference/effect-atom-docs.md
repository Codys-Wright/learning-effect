...
export const countPullAtom: Atom.Writable<Atom.PullResult<number>, void> = Atom.pull(
...
export const numberParamAtom: Atom.Writable<Option.Option<number>> = Atom.searchParam("number", {
